...
internal class SongMetadataExtractorTest {
    ...
    fun extractTxtFileNull() {
        ...
        //act
        val result = SongMetadataExtractor.extract(textFile)
    ...
    fun extractMp3FileResultHasMetadata() {
        ...
        //act
        val result = SongMetadataExtractor.extract(mp3File) ?: throw IllegalStateException("result must not be null!")
